...
HD_PWD='C:/Users/Utilisateur/Documents/Cours/Architect/TP1/TP1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log design_tp1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source design_tp1.tcl -notrace
