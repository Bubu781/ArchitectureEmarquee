...
HD_PWD='C:/Users/Utilisateur/Documents/Cours/Architect/TP1/TP1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_tp1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_tp1.tcl
