...
#
# Generated by export_simulation on Sat Dec 12 22:03:37 +0100 2020
#
################################################################################
...
'-reset_run' switch to the './design_tp1.sh' script.

./design_tp1.sh -reset_run
...
./design_tp1.sh -noclean_files

For more information on the script, please type './design_tp1.sh -help'.
